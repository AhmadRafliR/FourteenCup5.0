...
function activateCountdown(element, dateString) {
    ...
    element.querySelector(".until__event").textContent = `See you in, ${targetDate.format("D MMMM YYYY")}`;
...
activateCountdown(document.getElementById("myCountdown"), "2023-10-01");